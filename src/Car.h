...
class Car {
  public:
    ...
    float gearThrottleResponses[8] = {1,    0.3,  0.18, 0.15, 0.13,
                                      0.11, 0.09, 0.06}; // Throttle sensitivity - Should feel lower in higher gears since the high gears is hard on the engine.
